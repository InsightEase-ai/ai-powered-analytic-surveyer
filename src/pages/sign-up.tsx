...
const schema = z
  .object({
    ...
    terms: z
      .boolean()
      .refine((val) => val === true, { message: "Must agree to terms" }),
  })
...
function SignUp() {
  ...
  const onSubmit = async (data: FormData) => {
    setServerError(null); // Clear any old errors
    ...
    try {
      await signIn("password", {
        ...
        flow: "signUp", // Tells Convex to create a NEW user account
        fullName: data.fullName, // Stores the full name in the user table
        ...
        <div className="w-full bg-white rounded-3xl shadow-xl flex flex-col md:flex-row overflow-hidden my-auto shrink min-h-0">
              ...
              <div className="relative">
                ...
                <div className="absolute -top-12 -left-4 lg:-top-16 lg:-left-6 bg-gray-200 text-[#0B192C] text-xs px-3 py-2 lg:px-4 lg:py-3 rounded-2xl shadow-lg w-44 lg:w-52 opacity-95">
                  ...
                  <p className="text-[10px] lg:text-xs">
                    Let's start your data insights journey!
                  </p>
                  {/* Tooltip tail */}
          ...
          <div className="w-full md:w-1/2 bg-white relative min-h-0 overflow-y-auto flex flex-col">
            <div className="my-auto flex flex-col w-full h-full px-8 py-5 lg:px-12 lg:py-6">
              ...
              <p className="text-gray-500 mb-4 text-xs lg:text-sm">
                Start your insights journey with InsightEase.
              </p>
              ...
              >
                {/* Roles */}
                <div>
                  <label className="block text-[11px] lg:text-xs font-bold text-gray-900 mb-1.5">
                    I am a...
                  </label>
                  <Controller
                    name="role"
                      ...
                      <div className="flex gap-2 w-full justify-between">
                        {[
                          ...
                          >
                            <role.icon
                              size={16}
                              className="mb-0.5 lg:w-[18px] lg:h-[18px]"
                              strokeWidth={2.5}
                            />
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[11px] font-bold text-gray-900 mb-1 lg:mb-1.5">
                      Full Name
                    </label>
                    <div className="relative">
                    ...
                    {errors.fullName && (
                      <p className="text-red-500 text-[9px] mt-0.5 px-2">
                  ...
                  {requirements.map((req, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <Check
                        size={12}
                        className={
                          req.valid ? "text-[#087F8C]" : "text-gray-300"
                        }
                        strokeWidth={3}
                      />
                      <span
                        className={`text-[9px] lg:text-[10px] ${req.valid ? "text-gray-700" : "text-gray-500"}`}
                      >
                        {req.label}
                      </span>
                    </div>
                ...
                <div className="mt-1">
                  <label className="flex items-center cursor-pointer group">
                    ...
                    <span className="ml-2 text-[10px] lg:text-[11px] text-gray-700">
                      ...
                      <a
                        href="#"
                        className="font-bold text-[#087F8C] hover:underline"
                      >
                        Terms of Service
                      </a>{" "}
                      and{" "}
                  ...
                  {errors.terms && (
                    <p className="text-red-500 text-[9px] mt-0.5 px-1">
                ...
                <div className="flex items-center justify-center my-1.5 opacity-60">
                  ...
                  <span className="px-3 text-[9px] lg:text-[10px] font-semibold text-gray-400 uppercase tracking-widest">
                    or
                  </span>
                  <div className="border-t border-gray-200 flex-grow"></div>
                </div>
                ...
                <div className="text-center mt-1">
                  <p className="text-gray-600 text-[11px] lg:text-xs">
                    ...
                    <a
                      href="/"
                      className="text-[#087F8C] font-bold ml-1 hover:underline"
                    >
                      Sign in
                    </a>
                  </p>
