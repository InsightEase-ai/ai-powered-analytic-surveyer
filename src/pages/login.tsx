        ...
        <div className="w-full bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden my-auto shrink min-h-0">
          ...
          <div className="bg-[#0B192C] text-white w-full md:w-1/2 p-8 lg:p-10 flex flex-col justify-between relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <p className="text-[#8BB1D4] text-base lg:text-lg">
              ...
              <div className="relative">
                ...
                <div className="absolute -top-12 -left-4 lg:-top-16 lg:-left-6 bg-gray-200 text-[#0B192C] text-xs px-3 py-2 lg:px-4 lg:py-3 rounded-2xl shadow-lg w-44 lg:w-52 opacity-95">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-bold text-[9px] lg:text-[10px] tracking-wider uppercase">
                      Sherpa Insight
                    </span>
                  </div>
                  <p className="text-[10px] lg:text-xs">
                    Ready to map your data journey?
                  </p>
                  {/* Tooltip tail */}
                ...
                <img
                  src={heroImg}
                  alt="Data Sherpa"
                  className="w-[180px] h-[180px] lg:w-[260px] lg:h-[260px] object-cover rounded-xl shadow-2xl relative z-10"
                />
              </div>
            </div>
            ...
            <div className="relative z-10">
              <p className="text-[#8BB1D4] text-xs lg:text-sm leading-relaxed max-w-sm">
                Join 10,000+ researchers gaining deep clarity through
                expert-guided analytics.
              </p>
            </div>
          ...
          <div className="w-full md:w-1/2 bg-white relative min-h-0 overflow-y-auto flex flex-col">
            <div className="my-auto flex flex-col w-full h-full px-8 py-6 lg:px-12 lg:py-8">
              ...
              <p className="text-gray-500 mb-4 lg:mb-6 text-xs lg:text-sm">
                Sign in to continue your insights journey.
              </p>
              ...
              >
                      ...
                      <div className="flex gap-2 w-full justify-between">
                        {[
                          ...
                          <button
                            ...
                            className={`flex flex-col items-center justify-center py-2 lg:py-3 px-1 lg:px-2 flex-1 rounded-xl lg:rounded-2xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md ${
                              field.value === role.id
                          ...
                          >
                            <role.icon
                              size={16}
                              className="mb-1 lg:w-[18px] lg:h-[18px]"
                              strokeWidth={2.5}
                            />
                            <span className="text-[8px] lg:text-[9px] font-bold tracking-wider">
                              {role.label}
                            </span>
                          </button>
                        ))}
                ...
                {/* Email Address */}
                <div>
                  <label className="block text-[11px] lg:text-sm font-bold text-gray-900 mb-1 lg:mb-2">
                    Email Address
                  </label>
                    <input
                      type="email"
                      ...
                      {...register("email")}
                      className={`w-full bg-gray-100 border-none rounded-full px-4 py-2.5 lg:px-5 lg:py-3 focus:ring-2 focus:ring-[#0B192C] outline-none text-gray-800 placeholder-gray-400 text-xs lg:text-sm transition-shadow duration-200 hover:bg-gray-200 focus:bg-white ${
                        errors.email ? "ring-2 ring-red-500" : ""
                      }`}
                    />
                  {errors.email && (
                    <p className="text-red-500 text-[10px] lg:text-xs mt-1 px-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        <EyeOff size={16} className="lg:w-[18px] lg:h-[18px]" />
                      ) : (
                ...
                <div className="flex items-center justify-between mt-0.5">
                  <label className="flex items-center cursor-pointer group">
                    ...
                    <span className="ml-2 text-[11px] lg:text-sm text-gray-600 group-hover:text-gray-900 transition-colors">
                      Remember me
                    </span>
                  </label>
                  <a
                    href="#"
                    className="text-[11px] lg:text-sm font-medium text-[#087F8C] hover:text-[#065b64] transition-colors"
                  >
                    Forgot Password?
                  </a>
                </div>
                ...
                {serverError && (
                  <div className="p-2.5 text-xs text-red-600 bg-red-50 border border-red-200 rounded-full text-center font-medium">
                    {serverError}
                  </div>
                )}
                ...
                <button
                  type="submit"
                  className="w-full bg-[#0B192C] hover:bg-[#112a4a] text-white font-medium rounded-full py-2.5 lg:py-3 mt-1 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 text-xs lg:text-sm"
                  disabled={loading}
                >
                ...
                <div className="flex items-center justify-center my-1">
                  ...
                  <span className="px-3 text-[10px] lg:text-xs font-semibold text-gray-400 uppercase tracking-widest">
                    or
                  </span>
                  <div className="border-t border-gray-200 flex-grow"></div>
                </div>
                ...
                <div className="text-center mt-1">
                  <p className="text-gray-600 text-[11px] lg:text-sm">
                    ...
                    <Link
                      to="/sign-up"
                      className="text-gray-900 font-bold ml-1 hover:underline"
                    >
                      Sign up
                    </Link>
                  </p>
      ...
      <footer className="w-full max-w-5xl mt-4 pt-4 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between text-xs lg:text-sm text-gray-500 pb-2 shrink-0">
        <div className="flex flex-col gap-1 mb-2 md:mb-0 items-center md:items-start">
          ...
          <span className="text-[10px] lg:text-xs">
            © 2024 InsightEase. Guided by the Data Sherpa.
          </span>
        </div>
